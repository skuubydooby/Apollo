...
Jelly uses the fork and run architecture for a variety of jobs. These jobs will all first spawn a new process specified by the [`spawnto_x86`](/agents/Jelly/commands/spawnto_x86) or [`spawnto_x64`](/agents/Jelly/commands/spawnto_x64) commands. The parent process of these new processes is specified by the [`ppid`](/agents/Jelly/commands/ppid/) command. Once the process is spawned, Jelly will use the currently set injection technique to inject into the remote process.
