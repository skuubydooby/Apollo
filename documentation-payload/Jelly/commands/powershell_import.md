...
## Summary
Cache a .ps1 file to be used in other post-exploitation jobs. This command is a thin wrapper around the [`register_file`](/agents/Jelly/commands/register_file/) command.
