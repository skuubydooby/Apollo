...
## Summary
Peer-to-peer communication over a network socket. Jelly will bind to a specified port and await an incoming link request before establishing communications back to Mythic.
