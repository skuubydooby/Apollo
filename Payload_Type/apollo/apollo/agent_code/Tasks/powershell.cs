...
namespace Tasks
{
    public class powershell : Tasking
    {
        ...
        public powershell(IAgent agent, Interop.Structs.MythicStructs.MythicTask data) : base(agent, data)
        {
            _flushMessages = () =>
            {
                string output = "";
        ...
        private void OnBufferWrite(object sender, Interop.Classes.Events.StringDataEventArgs e)
        {
            if(e.Data != null)
            {
                try
