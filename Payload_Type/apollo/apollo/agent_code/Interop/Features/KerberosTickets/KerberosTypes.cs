...
using Interop.Enums;
using Interop.Features.WindowsTypesAndAPIs;
using static Interop.Features.WindowsTypesAndAPIs.WinNTTypes;
using static Interop.Features.WindowsTypesAndAPIs.LSATypes;
using static Interop.Features.WindowsTypesAndAPIs.APIInteropTypes;
using System.Runtime.Serialization;

namespace Interop.Features.KerberosTickets;
